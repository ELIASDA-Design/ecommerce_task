            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="pt-15 w-4/5 mb-6">
                        <form method="GET" action="{{route("add-product")}}">
                            @csrf
                            ...
                            <table class="w-full text-left table-auto min-w-max">
                                ...
                                @foreach($products as $product)
                                    <tr class="border-b border-blue-gray-100">
                                        ...
                                        <td>
                                            <div>
                                                <img width="60" height="60" src="{{ asset('images/product.jpg') }}" alt="">
                                            </div>
                                        </td>
                                        <td class="flex space-x-6 items-center">
                                            ...
                                            <x-modal name="delete-product-{{$product->id}}" :show="$errors->userDeletion->isNotEmpty()" focusable>
                                                <form method="post" action="{{ route('delete-product') }}" class="p-6">
                                                    @csrf
