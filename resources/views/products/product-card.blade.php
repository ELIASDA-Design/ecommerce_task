<div class="relative m-10 flex flex-col overflow-hidden rounded-lg border border-gray-100" style="width: 400px;">
    ...
    <div class="mt-4 px-5 pb-5">
        ...
        @if(auth()->check())
            @if($product->stock_quantity>0)
                <form method="POST" action="{{route("add-cart")}}" style="display: flex;justify-content: center;">
                    @csrf
                    ...
                    <button type="submit" class="flex items-center justify-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300"
                            style="background-color: crimson;padding-block: 4px;margin-bottom: 15px;margin-top: 15px;">
